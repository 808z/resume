...
\vspace{0pt}
  \section{Education}
  \headingBf{The University of Texas at El Paso \hspace{7.0cm}Expected Graduation Date: December 2026}{}
...
\vspace{0pt}
  \section{Technical Skills}
    \headingIt{\textbf{Languages}: Java(2y), Python, HTML/CSS, JavaScript, TypeScript, Swift, LaTeX, Verilog HDL}{}
    \vspace{1pt}
...
\vspace{0pt}
\headingBf{\large{HAWK RTL Design for Pedestrian Crosswalk}}{November 2024}
\begin{resume_list}
...
\vspace{0pt}
\headingBf{\large{Wordle}}{November 2023}
\begin{resume_list}
