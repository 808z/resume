...
\begin{document}
  ...
  \documentTitle{\textbf{Jeremy Galarza}}{
    \href{tel:9152551334}{
      \raisebox{-0.05\height} \faPhone\ (915) 255-1334} ~ | ~
...
\vspace{0pt}
  \section{Education}
  \headingBf{The University of Texas at El Paso \hspace{7.5cm}Expected Graduation Date: May 2027}{}
  \vspace{1pt}
...
\vspace{0pt}
  \section{Technical Skills}
    \headingIt{\textbf{Languages}: Java (2y), Python (6m), HTML/CSS (3y), JavaScript (2m), TypeScript (2m), Swift (3m), LaTeX (4m)}{}
    \vspace{1pt}
...
\vspace{0pt}
\headingBf{\large{HAWK RTL Design for Pedestrian Crosswalk (Digital Systems Design)}}{November 2024}
\begin{resume_list}
