...
\begin{resume_list}
  \vspace{1pt}
    \item I'm currently developing an iOS app that leverages \textbf{on-device AI models} to provide the user with real-time guidance during outdoor activities.
    \vspace{1pt}
    \item Utilizes \textbf{MLC-LLM} in tandem with \textbf{Gemma} for real-time speech recognition to provide user assistance.
    \vspace{1pt}
    \item Integrates the \textbf{MediaPipe framework} to provide contextually-aware assistance.
\end{resume_list}
